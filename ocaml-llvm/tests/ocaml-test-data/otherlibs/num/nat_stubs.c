...
Val_long(Wosize_val(nat)

- 1);
}

CAMLprim value
set_to_zero_nat(value
nat,
value ofs, value
len)
{
...
{
return
Val_long(Digit_val(nat, Long_val(ofs)));
}

CAMLprim value
set_digit_nat_native(value
nat,
value ofs, value
digit)
{
...
CAMLprim value
nth_digit_nat_native(value
nat,
value ofs
)
{
return
caml_copy_nativeint(Digit_val(nat, Long_val(ofs)));
}

CAMLprim value
num_digits_nat(value
nat,
value ofs, value
len)
{
return
Val_long(bng_num_digits(&Digit_val(nat, Long_val(ofs)),
    Long_val(len)));
}

CAMLprim value
num_leading_zero_bits_in_digit(value
nat,
value ofs
)
{
...
{
return
Val_bool(Digit_val(nat, Long_val(ofs)) <= Max_long);
}
...
{
return
Val_bool(Digit_val(nat, Long_val(ofs)) == 0);
}

CAMLprim value
is_digit_normalized(value
nat,
value ofs
)
{
return
Val_bool(Digit_val(nat,
    Long_val(ofs)) & ((bngdigit)1 << (BNG_BITS_PER_DIGIT-1)));
}
...
{
return
Val_bool(Digit_val(nat, Long_val(ofs)) & 1);
}
...
{
return
Val_long(bng_add_carry(&Digit_val(nat, Long_val(ofs)),
Long_val(len), Long_val(carry_in)
));
}

value add_nat_native(value
nat1,
value ofs1, value
len1,
value nat2, value
...
{
return
Val_long(bng_add(&Digit_val(nat1, Long_val(ofs1)),
Long_val(len1),
&Digit_val(nat2, Long_val(ofs2)),
Long_val(len2),
    Long_val(carry_in)
...
{
return
add_nat_native(argv[0], argv[1], argv[2], argv[3],
    argv[4], argv[5], argv[6]
);
}

CAMLprim value
complement_nat(value
nat,
value ofs, value
len)
{
bng_complement(&Digit_val(nat, Long_val(ofs)),
Long_val(len)
);
return
Val_unit;
...
carry_in)
{
return Val_long(1 ^ bng_sub(&Digit_val(nat1, Long_val(ofs1)),
Long_val(len1),
&Digit_val(nat2, Long_val(ofs2)),
Long_val(len2),
1 ^
...
{
return
sub_nat_native(argv[0], argv[1], argv[2], argv[3],
    argv[4], argv[5], argv[6]
);
}

value mult_digit_nat_native(value
nat1,
value ofs1, value
len1,
value nat2, value
...
CAMLprim value
mult_digit_nat(value
*argv,
int argn
)
{
return
mult_digit_nat_native(argv[0], argv[1], argv[2], argv[3],
    argv[4], argv[5], argv[6], argv[7]
);
}

value mult_nat_native(value
nat1,
value ofs1, value
len1,
value nat2, value
...
{
return
Val_long(bng_mult_add(&Digit_val(nat1, Long_val(ofs1)),
Long_val(len1),
&Digit_val(nat2, Long_val(ofs2)),
Long_val(len2),
&Digit_val(nat3, Long_val(ofs3)),
...
{
return
mult_nat_native(argv[0], argv[1], argv[2], argv[3],
    argv[4], argv[5], argv[6], argv[7], argv[8]
);
}

value square_nat_native(value
nat1,
value ofs1, value
len1,
value nat2, value
...
{
return
Val_long(bng_square_add(&Digit_val(nat1, Long_val(ofs1)),
Long_val(len1),
&Digit_val(nat2, Long_val(ofs2)),
Long_val(len2)
));
...
{
return
square_nat_native(argv[0], argv[1], argv[2],
    argv[3], argv[4], argv[5]
);
}

value shift_left_nat_native(value
nat1,
value ofs1, value
len1,
value nat2, value
...
{
Digit_val(nat2, Long_val(ofs2)) =
bng_shift_left(&Digit_val(nat1, Long_val(ofs1)),
Long_val(len1),
    Long_val(nbits)
);
return
...
CAMLprim value
shift_left_nat(value
*argv,
int argn
)
{
return
shift_left_nat_native(argv[0], argv[1], argv[2],
    argv[3], argv[4], argv[5]
);
}

value div_digit_nat_native(value
natq,
value ofsq,
    value
natr,
...
{
return
div_digit_nat_native(argv[0], argv[1], argv[2], argv[3],
    argv[4], argv[5], argv[6], argv[7], argv[8]
);
}

value div_nat_native(value
nat1,
value ofs1, value
len1,
value nat2, value
...
{
bng_div_rem(&Digit_val(nat1, Long_val(ofs1)),
Long_val(len1),
&Digit_val(nat2, Long_val(ofs2)),
Long_val(len2)
);
...
{
return
div_nat_native(argv[0], argv[1], argv[2],
    argv[3], argv[4], argv[5]
);
}

value shift_right_nat_native(value
nat1,
value ofs1, value
len1,
value nat2, value
...
{
Digit_val(nat2, Long_val(ofs2)) =
bng_shift_right(&Digit_val(nat1, Long_val(ofs1)),
Long_val(len1),
    Long_val(nbits)
);
return
...
CAMLprim value
shift_right_nat(value
*argv,
int argn
)
{
return
shift_right_nat_native(argv[0], argv[1], argv[2],
    argv[3], argv[4], argv[5]
);
}

CAMLprim value
compare_digits_nat(value
nat1,
value ofs1,
    value
nat2,
...
value compare_nat_native(value
nat1,
value ofs1, value
len1,
value nat2, value
...
{
return
compare_nat_native(argv[0], argv[1], argv[2],
    argv[3], argv[4], argv[5]
);
}

CAMLprim value
land_digit_nat(value
nat1,
value ofs1, value
nat2,
value ofs2
...
static void serialize_nat(value
nat,
uintnat *wsize_32,
    uintnat
* wsize_64)
