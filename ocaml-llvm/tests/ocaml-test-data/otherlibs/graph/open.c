    ...
    if (caml_gr_initialized) {
        ...
        *q = 0;
        ...
        if (caml_gr_display == NULL) {
            ...
            if (caml_gr_display == NULL) {
                caml_gr_fail("Cannot open display %s",
        ...
        caml_gr_window.win =
            XCreateSimpleWindow(caml_gr_display,
                DefaultRootWindow(caml_gr_display),
        ...
        XSetStandardProperties(caml_gr_display, caml_gr_window.win, p, p,
            None, NULL, 0, &hints);
        caml_gr_window.gc = XCreateGC(caml_gr_display, caml_gr_window.win, 0,
            NULL);
        ...
        caml_gr_bstore.gc = XCreateGC(caml_gr_display, caml_gr_bstore.win, 0,
            NULL);
...
value caml_gr_close_graph(void)
{
    if (caml_gr_initialized) {
        ...
        if (caml_gr_font != NULL) {
            XFreeFont(caml_gr_display, caml_gr_font);
            caml_gr_font = NULL;
        }
...
void caml_gr_fail(char *fmt, char *arg)
{
    ...
    if (graphic_failure_exn == NULL) {
        ...
        if (graphic_failure_exn == NULL) {
            invalid_argument(
                "Exception Graphics.Graphic_failure not initialized,"
