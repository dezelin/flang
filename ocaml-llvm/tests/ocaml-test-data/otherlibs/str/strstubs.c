        ...
        switch (Opcode(instr)) {
            ...
            case WORDBOUNDARY:
                ...
                if (txt == starttxt) {
                    ...
                    if (Is_word_letter(txt[-1]) != Is_word_letter(txt[0])) {
                        break;
                    }
                    goto backtrack;
                }
...
if (
re_match(re, starttxt, txt, endtxt,
0)) {
return
re_alloc_groups(re, str
);
} else {
return Atom(0);
}
