...
{
    /* Mirrors parse_tables in ../stdlib/parsing.mli */
    value actions;
    value transl_const;
    value transl_block;
    char *lhs;
...
struct parser_env
{
    /* Mirrors parser_env in ../stdlib/parsing.ml */
    value s_stack;
    value v_stack;
    ...
    struct parser_env *env, value cmd, value arg)
{
    ...
    switch (Int_val(cmd)) {
        ...
        case SEMANTIC_ACTION_COMPUTED:
            ...
            asp = Int_val(env->asp);
            Store_field (env->symb_end_stack, sp,
                Field(env->symb_end_stack, asp));
            if (sp > asp) {
                /* This is an epsilon production. Take symb_start equal to symb_end. */
                Store_field (env->symb_start_stack, sp,
                    Field(env->symb_end_stack, asp));
            }
            goto loop;
