...
CAMLprim value caml_int32_shift_left(value v1,
    value v2) { return caml_copy_int32(Int32_val(v1) << Int_val(v2)); }

CAMLprim value caml_int32_shift_right(value v1,
    value v2) { return caml_copy_int32(Int32_val(v1) >> Int_val(v2)); }
...
value caml_int32_direct_bswap(value v) { return caml_swap32(v); }
...
CAMLprim value caml_int32_to_int(value v) { return Val_long(Int32_val(v)); }
...
CAMLprim value caml_int64_shift_left(value v1,
    value v2) { return caml_copy_int64(Int64_val(v1) << Int_val(v2)); }

CAMLprim value caml_int64_shift_right(value v1,
    value v2) { return caml_copy_int64(Int64_val(v1) >> Int_val(v2)); }
...
CAMLprim value caml_nativeint_shift_left(value v1,
    value v2) { return caml_copy_nativeint(Nativeint_val(v1) << Int_val(v2)); }

CAMLprim value caml_nativeint_shift_right(value v1,
    value v2) { return caml_copy_nativeint(Nativeint_val(v1) >> Int_val(v2)); }
...
CAMLprim value caml_nativeint_of_string(value s)
{
    return caml_copy_nativeint(
        parse_intnat(s, 8 * sizeof(value), INTNAT_ERRMSG));
}
