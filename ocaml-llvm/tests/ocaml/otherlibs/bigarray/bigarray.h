...
struct caml_ba_proxy
{
    ...
    /* Reference count */
    void *data;
    /* Pointer to base of actual data */
...
struct caml_ba_array
{
    ...
    intnat flags;
    /* Kind of element array + memory layout + allocation status */
...
CAMLBAextern value
caml_ba_alloc_dims(int flags, int num_dims, void *data,
    ... /*dimensions, with type intnat */);
CAMLBAextern uintnat
caml_ba_byte_size(struct caml_ba_array *b);
