...
return
caml_ba_alloc(flags
| CAML_BA_MAPPED_FILE, num_dims, addr, dim);
}

CAMLprim value
caml_ba_map_file_bytecode(value
* argv,
int argn
)
{
return
caml_ba_map_file(argv[0], argv[1], argv[2],
