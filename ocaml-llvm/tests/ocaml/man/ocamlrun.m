...
the name
of the
bytecode executablefile; elements
1 to
.
I n
are the
...
.BR 0x100
Startup messages(loading
the bytecode
executable file, resolving
shared libraries
).
